---
title: Axios Python
description: A developer-experience-first HTTP client for Python, heavily inspired by Axios.
---
...
<Cards>
  <Card title="Getting Started" href="/docs/getting-started" description="Install the library and write your first request." />
  <Card title="Client API" href="/docs/client-api" description="Deep dive into the core properties of the axios_python client instance." />
  <Card title="Concurrent Requests" href="/docs/concurrent-requests" description="Run multiple API requests simultaneously and orchestrate results." />
  <Card title="Data Transformation" href="/docs/data-transformation" description="Modify request data and headers prior to transmission or parsing." />
  <Card title="Interceptors" href="/docs/interceptors" description="Mutate requests before they are sent or map responses." />
  <Card title="Middleware" href="/docs/middleware" description="Powerful async Express-style request wrappers." />
  <Card title="Retry Mechanisms" href="/docs/retry" description="Keep your app resilient with automatic backoffs." />
  <Card title="Request Cancellation" href="/docs/cancellation" description="Cancel long running requests with CancelTokens." />
  <Card title="Plugins System" href="/docs/plugins" description="Easily drop in caching, logging, and auth." />
  <Card title="Plugin Authoring" href="/docs/plugin-authoring" description="Build and distribute custom plugins for axios_python." />
  <Card title="Error Handling" href="/docs/error-handling" description="Learn about the robust exception hierarchy." />
  <Card title="Streaming" href="/docs/streaming" description="Iterate over large file downloads cleanly." />
  <Card title="Best Practices" href="/docs/best-practices" description="Production guidance for building with axios_python." />
  <Card title="Before vs After" href="/docs/before-vs-after" description="Real world comparisons to raw httpx and requests." />
</Cards>
...
Install the package via `pip` natively.
...
# Option A: Zero-setup module level request
response = axios_python.get("https://httpbin.org/get", params={"query": "python"})

# Option B: Create an isolated instance with default configuration
...
`axios_python` treats async as a first-class citizen. Just use `async_get`, `async_post`, etc.
...
Handle streaming and file uploads identically to familiar requests libraries.
